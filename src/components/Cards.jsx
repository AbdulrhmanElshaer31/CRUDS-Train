...
export default function Cards({ product }) {
  ...
  return (
    <div className="w-full max-w-75 sm:w-75 h-auto sm:h-125 rounded-2xl flex flex-col border border-gray-300 transition-all duration-500 group hover:shadow-2xl hover:-translate-y-1.5 bg-white">
      ...
      {/* product image */}
      <div className="w-full h-48 sm:h-70 p-4 sm:p-5 rounded-t-2xl rounded-tr-2xl flex justify-center items-center relative bg-gray-100 overflow-hidden">
      ...
      <div className="py-3 sm:py-4 px-4 sm:px-5 flex justify-between items-center">
        ...
        <Button
          ...
          className="bg-black text-white rounded-full px-4 py-2.5 sm:px-5 sm:py-3 hover:bg-[#D4AF37] hover:text-black transition-colors duration-300"
        />
      </div>
    </div>
  );
