export async function login(username, password){
    try {
        const request = await fetch('https://aefgkdxaustxossfirqh.supabase.co/rest/v1/rpc/auth_login', {
            method: "POST",
            headers: {
...
export async function logout(token){
    try {
        const request = await fetch('https://aefgkdxaustxossfirqh.supabase.co/rest/v1/auth_tokens?token=eq.' + token, {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
                "apikey": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImFlZmdrZHhhdXN0eG9zc2ZpcnFoIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzA0NjU5MjMsImV4cCI6MjA4NjA0MTkyM30.L4kUCFnOp8xyLmgr6KcGk5_cpSSooU2Lj997buHsL20",
